...
class Kernel implements KernelContract
{
	 ...
	 * 加载配置
	 * 引入异常
	 * 注册 Facades, 就是 config\app.php 中的 aliases 数组，如 Auth, Cache, DB 等等
	 * 注册 Providers
	 * 最后是执行 boot 方法
	 * 所以，你可以在 ServiceProviders 的register方法中使用任何Facades, 在 ServiceProviders 的
	 * boot 方法中使用任何 register 方法中注册的实例或者 Facades，这样绝不会产品依赖某个类而未注册的现象。
     */
